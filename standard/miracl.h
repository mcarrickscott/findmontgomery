...
extern void  fmul_m(_MIPT_ flash,flash,flash);      
extern void  fdiv_m(_MIPT_ flash,flash,flash);      
extern void  fadd_m(_MIPT_ flash,flash,flash);      
extern void  fsub_m(_MIPT_ flash,flash,flash);      
